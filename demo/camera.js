...
shaderProgram.getUniform('colorCoefficient').setUniform1f(255);
shaderProgram.getUniform('postitonCoefficient').setUniform1f(10);

var sk = game.readSkeleton("demo/skeleton.yaml", m3d.vertex.length/3);
var anim = game.createAnimation(d1, sk);
window.add(anim);
...
function surroundOP(used, cm) {
  ...
  camMoveTo.line(used, [modwhere[0]+0.3, 0, modwhere[2]+3]);
}
